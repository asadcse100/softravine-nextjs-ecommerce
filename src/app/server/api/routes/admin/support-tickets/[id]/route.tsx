...
import { deleteSupportTicket, getSupportTicketById } from '@/app/server/controllers/SupportTicketController';
...
//         const category = await deleteSupportTicket(Number(id), categoryName);
