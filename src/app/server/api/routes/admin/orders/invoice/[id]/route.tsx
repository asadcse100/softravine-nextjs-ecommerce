...
import { deleteInvoice, getInvoiceById, createOrUpdateInvoice } from '@/app/server/controllers/InvoiceController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateInvoice(Number(id), categoryName);
