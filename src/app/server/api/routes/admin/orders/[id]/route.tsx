...
import { deleteOrder, getOrderById, createOrUpdateOrder } from '@/app/server/controllers/OrderController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateOrder(Number(id), categoryName);
