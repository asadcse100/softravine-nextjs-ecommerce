...
import { deleteSellerProduct, getSellerProductById } from '@/app/server/controllers/ProductController';
...
export async function GET(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        const result = await getSellerProductById(Number(id));
...
export async function DELETE(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        await deleteSellerProduct(Number(id));
