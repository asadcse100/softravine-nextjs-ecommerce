...
import { createOrUpdateDigitalProduct, deleteDigitalProduct, getDigitalProductById } from '@/app/server/controllers/DigitalProductController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateDigitalProduct(Number(id), categoryName);
