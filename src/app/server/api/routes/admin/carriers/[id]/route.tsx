...
import { createOrUpdateCarrier, deleteCarrier, getCarrierById } from '@/app/server/controllers/CarrierController';
...
export async function GET(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        const result = await getCarrierById(Number(id));
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateCarrier(Number(id), categoryName);
