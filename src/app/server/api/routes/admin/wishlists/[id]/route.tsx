...
import { deleteWishlist, getWishlistById, createOrUpdateWishlist } from '@/app/server/controllers/WishlistController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateWishlist(Number(id), categoryName);
