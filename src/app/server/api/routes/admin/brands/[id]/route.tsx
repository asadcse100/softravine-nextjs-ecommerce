...
import { createOrUpdateBrand, deleteBrand, getBrandById } from '@/app/server/controllers/BrandController';
...
export async function GET(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        const result = await getBrandById(Number(id));
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateBrand(Number(id), categoryName);
