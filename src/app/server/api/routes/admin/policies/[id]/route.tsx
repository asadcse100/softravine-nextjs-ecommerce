...
import { deletePolicy, getPolicyById, createOrUpdatePolicy } from '@/app/server/controllers/PolicyController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdatePolicy(Number(id), categoryName);
