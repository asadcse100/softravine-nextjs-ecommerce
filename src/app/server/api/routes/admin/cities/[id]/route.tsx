...
import { createOrUpdateCity, deleteCity, getCityById } from '@/app/server/controllers/CityController';
...
export async function GET(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        const result = await getCityById(Number(id));
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateCity(Number(id), categoryName);
