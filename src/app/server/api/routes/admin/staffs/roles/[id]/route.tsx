...
import { deleteRole, getRoleById, createOrUpdateRole } from '@/app/server/controllers/RoleController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateRole(Number(id), categoryName);
