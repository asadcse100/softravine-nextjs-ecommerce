...
import { getSellerWithdrawRequestById } from '@/app/server/controllers/SellerWithdrawRequestController';
...
export async function GET(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        const result = await getSellerWithdrawRequestById(Number(id));
