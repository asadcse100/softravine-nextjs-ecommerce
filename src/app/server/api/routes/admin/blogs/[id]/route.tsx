...
import { createOrUpdateBlogPost, deleteBlogPost, getBlogById } from '@/app/server/controllers/BlogController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateBlogPost(Number(id), categoryName);
