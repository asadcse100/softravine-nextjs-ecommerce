...
import { createOrUpdateCustomer, deleteCustomer, getCustomerById } from '@/app/server/controllers/WholesaleProductController';
...
export async function PUT(req: Request, { params }: { params: { id: number } }) {
    ...
    try {
        ...
        const category = await createOrUpdateCustomer(Number(id), categoryName);
