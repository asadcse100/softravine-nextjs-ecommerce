...
export const createOrUpdatePurchaseHistory = async (id: number) => {
  // code
};
...
export const downloadProduct = async (data: createOrUpdateData) => {
    try {
        ...
        const userId = Number(data.userid); // Assuming you're passing user ID in headers
