...
export const loadTodaysDealSection = async (data: createOrUpdateData) => {
  try {
    ...
    return { success: true, data: todaysDealProducts };
...
export const loadNewestProductSection = async (data: createOrUpdateData) => {
  try {
    ...
    return { success: true, data: newestProducts };
  ...
  try {
    ...
    if (user.user_type === 'seller') {
      ...
      const message = usersCart
        ...
        : null;
      return { success: true, data: customer_dashboard };
...
export const getFlashDealDetails = async (data: createOrUpdateData) => {
  try {
    ...
    return { success: true, data: flashDeal };
...
export const getShopDetails = async (data: createOrUpdateData) => {
  try {
    ...
    if (shop.verification_status !== 0) {
      return { success: true, data: shop, verified: true };
      // return res.status(200).json({ shop, verified: true });
    } else {
      return { success: true, data: shop, verified: false };
...
export const filterShop = async (data: createOrUpdateData) => {
  try {
    ...
    if (type === 'all-products') {
      ...
      return { success: true, data: shop, type, products };
      // return res.status(200).json({ shop, type, products });
    }
    return { success: true, data: shop, type };
...
export const updateEmail = async (data: createOrUpdateData) => {
  try {
    ...
    const isUnique = await checkEmailUniqueness(data.email); // You need to implement this function

    // if (isUnique) {
    const updateEmail = await sendEmailChangeVerificationMail(data.email);
    // return res.status(200).json({ message: 'Verification email sent successfully' });
    // }

    return { success: true, data: isUnique, updateEmail };
...
export const sendEmailVerificationMail = async (data: createOrUpdateData) => {
  try {
    ...
    const sendEmailVerificationMail = await sendVerificationEmail(email, verificationCode);

    return { success: true, data: sendEmailVerificationMail };
...
export const getAllFlashDeals = async (data: createOrUpdateData) => {
  try {
    ...
    return { success: true, data: allFlashDeals };
...
export const getAllVerifiedSellers = async (data: createOrUpdateData) => {
  try {
    ...
    return { success: true, data: verifiedSellers };
