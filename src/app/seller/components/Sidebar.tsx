...
export default function Sidebar() {
  ...
  const asideStyle = classNames(
    "sidebar overflow-y-auto fixed border-stroke bg-white px-7.5 dark:border-strokedark dark:bg-boxdark text-gray-500 z-50 h-full shadow-lg shadow-gray-900/20 transition duration-300 ease-in-out w-[16rem]",
    {
