...
const PaymentMethod: FC<Props> = ({
  ...
  const renderPaymentMethod = () => {
    return (
      <div className="bg-white dark:bg-slate-700 shadow-md rounded-xl ">
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <button
            className="py-2 px-4 bg-green-200 hover:bg-green-400 dark:bg-slate-800 dark:hover:bg-slate-700 mt-5 sm:mt-0 sm:ml-auto text-sm font-medium rounded-lg"
