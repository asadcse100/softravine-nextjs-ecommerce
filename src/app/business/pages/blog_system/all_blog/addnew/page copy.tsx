...
const formSchema = z.object({
  ...
  short_description: z.string().min(5, {
    message: "Blog Short description must be at least 5 characters.",
  }),
  description: z.string().min(100, {
    message: "Blog description must be at least 100 characters.",
  }),
  meta_title: z.string(),
  meta_img: z.string(),
...
export default function Addnew() {
  ...
  const editor = useEditor({
    ...
    content: '<p className="dark:text-slate-200">Start writing here...</p>',
  });

  const handleSave = () => {
    const content = editor?.getHTML();
    console.log(content); // Save this content to your database
  };
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <div className="grid grid-cols-1 md:grid-cols-12">
                              ...
                              <div className="col-span-8">
                              <button
          className={clsx('toolbar-button', { active: editor.isActive('bold') })}
          onClick={() => handleButtonClick(() => editor.chain().focus().toggleBold().run())}
        >
          Bold
        </button>
                              <EditorContent editor={editor} className="border p-4 rounded text-gray-700 bg-gray-50" />
                              </div>
                            </div>
                            <FormMessage />
                          </FormItem>
