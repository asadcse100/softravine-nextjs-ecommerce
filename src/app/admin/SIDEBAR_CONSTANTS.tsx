...
export const SIDENAV_ITEMS:SideNavItem[] = [
    ...
    },
    {
        ...
        submenu: true,
        subMenuItems: [
            {title: 'All', path: '/admin/pages/product/products'},
            {title: 'Add New', path: '/admin/pages/product/addnew'},
            {title: 'In House', path: '/admin/pages/product/admin'},
            {title: 'Digital', path: '/admin/pages/product/digital'},
            {title: 'Seller', path: '/admin/pages/product/seller',
            submenu: true,
            subMenuItems: [
                {title: 'Physical', path: '/admin/pages/product/seller/physical'},
                {title: 'Digital', path: '/admin/pages/product/seller/digital'},
            ]},
            ...
            {title: 'Size Guide', path: '/admin/pages/product/size_guide',
            submenu: true,
            subMenuItems: [
                {title: 'Size Chart', path: '/admin/pages/product/size_guide/guide'},
                {title: 'Digital', path: '/admin/pages/product/size_guide/points'},
            ]},
    ...
    },
    {
        ...
        subMenuItems: [
            ...
            {title: 'Coupon', path: '/admin/pages/marketing/coupon'},
        ],
    },
    {
        title: 'Support',
