...
const CartPage = () => {
    ...
    return (
      ...
      >
        <div className="relative h-36 w-24 sm:w-32 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-400">
          ...
          />
          <Link href="/frontend/pages/product-detail" className="absolute inset-0"></Link>
        </div>
            ...
            <div className="flex justify-between ">
              <div className="flex-[1.5] ">
                <h3 className="text-base font-semibold">
                  <Link href="/frontend/pages/product-detail">{name}</Link>
                </h3>
  ...
  return (
    <div className="nc-CartPage">
      <main className="container py-5 lg:pb-5 lg:pt-5">
        <div className="mb-5 sm:mb-5">
          ...
          <div className="block mt-3 sm:mt-5 text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-400">
            ...
            <Link href={"/frontend/pages/collection"} className="">
              Clothing Categories
            </Link>
            <span className="text-xs mx-1 sm:mx-1.5">/</span>
        ...
        <hr className="border-slate-300 dark:border-slate-700 my-5 xl:my-5" />

        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-[60%] xl:w-[55%] divide-y divide-slate-300 dark:divide-slate-500 ">
            {[
              PRODUCTS[0],
              PRODUCTS[1],
              PRODUCTS[2],
