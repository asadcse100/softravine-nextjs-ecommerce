...
const ContactInfo: FC<Props> = ({ isActive, onCloseActive, onOpenActive }) => {
  const renderAccount = () => {
    return (
      <div className="bg-white dark:bg-slate-700 rounded-xl overflow-hidden z-0 shadow-md">
        <div className="flex flex-col sm:flex-row items-start p-6 ">
          ...
          <button className="py-2 px-4 bg-green-200 hover:bg-green-400 dark:bg-slate-800 dark:hover:bg-slate-700 mt-5 sm:mt-0 sm:ml-auto text-sm font-medium rounded-lg"
