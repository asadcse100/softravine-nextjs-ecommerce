  ...
  const renderProductItem = (product, index) => {
    ...
    return (
      <div key={index} className="flex py-4 sm:py-7 last:pb-0 first:pt-0">
        <div className="relative h-24 w-16 sm:w-20 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-500">
          <Image
            fill
            sizes="100px"
            src={image}
            ...
            <div className="flex justify-between ">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                  <span>{"Natural"}</span>
                  <span className="mx-2 border-l border-slate-100 dark:border-slate-700 h-4"></span>
                  <span>{"XL"}</span>
                </p>
              </div>
  ...
  const renderOrder = () => {
    return (
      <div className="border border-slate-100 dark:border-slate-700 rounded-lg overflow-hidden z-0">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 sm:p-8 bg-white dark:bg-slate-500/5">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1.5 sm:mt-2">
              ...
              <span className="text-primary-500">Pending</span>
            </p>
          </div>
        ...
        <div className="border-t border-slate-300 dark:border-slate-700 p-2 sm:p-8 divide-y divide-slate-300 dark:divide-slate-700 bg-slate-50 dark:bg-slate-800">
