            ...
            <div className="flex justify-between ">
              <div>
                <h3 className="text-base font-medium ">
                  <Link onClick={close} href={"/frontend/pages/product-detail"}>
                    {name}
                  </Link>
                </h3>
      ...
      {({ open, close }) => (
        <>
          ...
          >
            ...
            <Link className="block md:hidden absolute inset-0" href={"/frontend/pages/cart"} />
          </Popover.Button>
          <Transition
            as={Fragment}
