...
const pages: {
  ...
  {
    name: "Recharge",
    link: "/pages/mobile-recharge",
  },
  {
    name: "Regular Offers",
    link: "/pages/mobile-recharge/regular-offers",
  },
  {
    name: "Recharge History",
    link: "/pages/mobile-recharge/recharge-history",
  },
];
      ...
      <div className="mt-5 sm:mt-5">
        <div className="max-w-4xl mx-auto">
          <div className="max-w-2xl">
            <h2 className="text-3xl xl:text-4xl font-semibold">Mobile Recharge</h2>
          </div>
