      ...
      <div className="mb-10">
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="flex-shrink-0 grid grid-cols-1 md:grid-cols-2 gap-12 ">
            <div className="max-w-sm space-y-8 bg-white dark:bg-gray-700 p-5 rounded-xl">
              {info.map((item, index) => (
                <div key={index}>
            ...
            <div>
              <form className="grid grid-cols-1 gap-6 bg-white dark:bg-gray-700 p-5 rounded-xl" action="#" method="post">
