...
import CardCategory4 from "@/app/(frontend)/components/CardCategories/CardCategory4";
import Heading from "@/app/(frontend)/components/Heading/Heading";
import NavItem2 from "@/app/(frontend)/components/NavItem2";
import Nav from "@/shared/Nav/Nav";
import CardCategory6 from "@/app/(frontend)/components/CardCategories/CardCategory6";
