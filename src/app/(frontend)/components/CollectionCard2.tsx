...
const CollectionCard2: FC<CollectionCard2Props> = ({
  ...
  return (
    <div className={`CollectionCard2 group relative ${className}`}>
      <div className="relative flex flex-col border border-slate-300 rounded-2xl">
        <NcImage
          containerClassName="aspect-w-8 aspect-h-5 bg-white dark:bg-slate-700 rounded-2xl overflow-hidden shadow-lg"
          className="object-contain w-full h-full rounded-2xl"
          src={imgs[0]}
          alt=""
          sizes="400px"
        />
        <div className="grid grid-cols-3 gap-2.5 mt-2.5 bg-white dark:bg-slate-700 shadow-md">
          <NcImage
        ...
        <div className="relative mt-2 flex justify-between bg-white dark:bg-slate-700 p-4 rounded-2xl">
        {/* TITLE */}
      ...
      <Link href={"/frontend/pages/product-detail-2"} className="absolute inset-0 "></Link>
      </div>
    </div>
  );
};
